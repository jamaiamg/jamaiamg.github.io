...
if ( ! class_exists('wp_megamenu_css')) {
    ...
    class wp_megamenu_css{
        ...
        public function generateCss($nav_key, $selected_theme_id){
            ...
            if(!empty($menubar_bg) && !empty($menubar_bg_2)){
                $style .= "
                    background-image: linear-gradient(-90deg, $menubar_bg, $menubar_bg_2);
                ";
            }
            ...
            if(!empty($top_level_item_bg_color) && !empty($top_level_item_bg_color_2)){
                $style .= "
                    background-image: linear-gradient(-90deg, $top_level_item_bg_color, $top_level_item_bg_color_2);
                ";
            }
...
//
            ...
            if(!empty($top_level_item_bg_hover_color) && !empty($top_level_item_bg_hover_color_2)){
                $style .= "
                    background-image: linear-gradient(-90deg, $top_level_item_bg_hover_color, $top_level_item_bg_hover_color_2);
                ";
            }
