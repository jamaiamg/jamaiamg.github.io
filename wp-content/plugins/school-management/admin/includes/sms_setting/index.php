...
<div class="page-title">
	...
	<h2 class="nav-tab-wrapper">
    	<a href="?page=smgt_sms-setting" class="nav-tab  nav-tab-active">
    ...
    <form action="" method="post" class="form-horizontal" id="sms_setting_form">  
			...
			<div class="col-sm-8">
				 <div class="radio">
				 	<label>
  						<input id="checkbox" type="radio" <?php echo checked($current_sms_service_active,'clickatell');?>  name="select_serveice" value="clickatell"> <?php _e('Clickatell','school-mgt');?> 
  					</label> 
  					&nbsp;&nbsp;&nbsp;&nbsp;
  					<label>
  						<input id="checkbox" type="radio"  <?php echo checked($current_sms_service_active,'twillo');?> name="select_serveice" value="twillo">  <?php _e('Twilio','school-mgt');?>
  					</label>
  				</div>
