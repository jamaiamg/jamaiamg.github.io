			...
			<h2>
					...
					<table class="form-table">	
							<tr class="user-user-login-wrap">
								...
								<td>
									 <input type="text" name="subject_name"  class="regular-text" value="<?php if($edit){ echo $subject->sub_name;}?>"/> 
								</td>
							</tr>
							<tr class="user-user-login-wrap">
								<th >
							...
							<tr class="user-user-login-wrap">
								...
								<td>
									 <input type="text" name="subject_edition"  class="regular-text" value="<?php if($edit){ echo $subject->edition;}?>"/> 
								</td>
							</tr>
							<tr class="user-user-login-wrap">
								<th >
								...
								<td>
									 <input type="text" name="subject_author"  class="regular-text" value="<?php if($edit){ echo $subject->author_name;}?>"/> 
								</td>
							</tr>
							 <tr class="user-user-login-wrap">
								<th >
